...
import {
  ...
  scanPerpetuals,scanSmartMoney,scanMomentum,scanYield,scanSolanaRadar,scanPolymarket,
...
function App(){
  ...
  return <div className="shell">
    ...
    <main className="dashboard">
      ...
      <BotConfigurationPanel state={state} bots={state.bots} onSelect={setSelected} onRun={runBot} onToggle={toggleFromConfig}/>
    ...
    {selected&&<BotDrawer bot={selected} onClose={()=>setSelected(null)} onRun={()=>runBot(selected.id)} onToggle={async()=>{await toggleBot(selected.id);setSelected(null)}}/>}
  </div>
}
